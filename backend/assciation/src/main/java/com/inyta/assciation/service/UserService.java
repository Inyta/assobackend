...
public class UserService extends ServiceImpl<UserMapper, User> {
  ...
  public void resetPassword(ResetPasswordDTO resetPasswordDTO) {
    ...
    SimpleHash hash = new SimpleHash(Md5Hash.ALGORITHM_NAME, resetPasswordDTO.getExPassword(), salt,
        5);
    SimpleHash hashcode = new SimpleHash(Md5Hash.ALGORITHM_NAME, resetPasswordDTO.getPassword(),
        salt, 5);
